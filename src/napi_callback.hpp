...
//
// This class is an external library originally released under the 
// ISC license. No license file was included with this library, so
// for more information, please visit the link above to the original
// repository. While only cosmetic changes have been made to the 
// original source, any current and future modifications of this code
// are to fall under the overarching license of this project. Please see
// the header of this file, or "LICENSE" for more details.
//////////////////////////////////////////////////////////////////////////
...
#include "napi_callback_impl.hpp"